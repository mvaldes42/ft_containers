...
namespace ft
{
	...
	class mapIterator
	{
		...
		public:
			...
			mapIterator(const mapIterator &other) : _node(other._node), _root(other._root), _endNode(other._endNode), _comp(other._comp) {};
			~mapIterator() {};
			...
			mapIterator & operator ++()
			{
				...
				if (_node == nullptr)
				{
					...
					if (_node == nullptr)
						return *this;
					std::cout << "(2)_node: " << _node << ", endNode: " << _endNode << std::endl;
